/*
  ...
  - Added the required column `tastcases` to the `Problem` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "Problem" ADD COLUMN     "codeSnippets" JSONB NOT NULL,
ADD COLUMN     "referenceSolutions" JSONB NOT NULL,
ADD COLUMN     "tastcases" JSONB NOT NULL;
