...
import { Bookmark, PencilIcon, Trash, Trash2Icon, Plus, TrashIcon } from "lucide-react";
...
const ProblemTable = ({ problems }) => {
  ...
  const itemPerPage = 5
  const totalPages = Math.ceil(filteredDifficulties.length / itemPerPage)
  const paginatedProblems = useMemo(()=> {
    return filteredDifficulties.slice(
      (currentPage - 1) * itemPerPage, currentPage * itemPerPage
    )
  }, [currentPage, filteredDifficulties])
